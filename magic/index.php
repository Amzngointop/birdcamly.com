...
define('CAMPAIGN_ID', "9fbbe115748cfa0176c7949789add8cd");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '4fa0762c6ba2ad162fea6bf6f292c7f6');
define('MP_PARAM_NAME', '__ke__clk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '959cd9b4312840228323bf780ff63c10');
define('CHECK_MCPROXY_VALUE', '6c2320b93c220b0b45dbfa92a9124ee83032b6a534bdb6da183100998dc6c1fb');
